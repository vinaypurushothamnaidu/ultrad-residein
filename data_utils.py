...
Its_train_loader = DataLoader(dataset = RESIDE_Dataset(path + 'resideh/RESIDE/ITS', train = True), 
                             batch_size = BS, shuffle = True)

Its_test_loader = DataLoader(dataset = RESIDE_Dataset(path + 'resideh/RESIDE/SOTS/indoor', train = False), 
                             batch_size = 1, shuffle = False)
